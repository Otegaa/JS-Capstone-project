...
- This project is called JS-Capstone. It is a movie website based on POSTING and GETTING data from an API.
...
- **[Gitflow is used]**
- **[Data is sent to API]**
- **[Data can be retrieved from an API]**

<p align="right">(<a href="#readme-top">back to top</a>)</p>

🚀 Live Demo

- https://otegaa.github.io/JS-Capstone-project/dist
...
```sh
  git clone https://github.com/Otegaa/JS-Capstone-project.git
...
- Github: [@githubhandle](https://github.com/mnaibei)
...
Feel free to check the [issues page](https://github.com/Otegaa/JS-Capstone-project/issues).
...
This project is [MIT](https://github.com/Otegaa/JS-Capstone-project/blob/development/LICENSE.md) licensed.
